    ...
    <>
      ...
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32">
          <div className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://i.ibb.co/zFhnNcz/2006-1.jpg')]"></div>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-control">
                      <label
                        htmlFor="Name"
                        className="label label-text text-primary"
                      >
                        Your Name
                      </label>
                      <input
                        ...
                        id="name"
                        name="name"
                        className="input input-bordered bg-transparent focus:border-primary border border-pink-400 text-white"
                    ...
                    <div className="form-control">
                      ...
                      {errors.email && (
                        <span className="text-white  mt-1 text-sm">
                          Please enter your service email.
                        </span>
                      )}
                    </div>
                    <div className="form-control">
                      ...
                      <textarea
                        ...
                        id="about"
                        name="about"
                        className="input input-bordered bg-transparent focus:border-primary border border-pink-400 text-white min-h-[100px] p-2"
                        {...register("about", {
                          required: true,
                          maxLength: 400,
                        })}
